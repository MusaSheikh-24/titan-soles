...
# authentication
- Do NOT auto-login or redirect users after signup; require them to sign in with their newly created account instead. Confidence: 0.70
- When user is logged in, replace Sign In/Sign Up navbar buttons with a Profile icon that shows a dropdown menu containing Dashboard and Logout options. Confidence: 0.70
