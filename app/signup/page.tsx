                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <User className={`absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 transition-colors ${focusedField === "name" ? "text-blue-600" : "text-gray-400"}`} />
                                <input
                                    type="text"
                                    value={name}
                                    ...
                                    className={`w-full pl-9 pr-3.5 py-2 bg-gray-50 border ${errors.name ? "border-red-400" : "border-gray-200 focus:border-blue-500"} rounded-lg text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all`}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <Lock className={`absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 transition-colors ${focusedField === "confirmPassword" ? "text-blue-600" : "text-gray-400"}`} />
                                <input
                                    ...
                                    onBlur={() => setFocusedField(null)}
                                    className={`w-full pl-9 pr-9 py-2 bg-gray-50 border ${errors.confirmPassword ? "border-red-400" : "border-gray-200 focus:border-blue-500"} rounded-lg text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all`}
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                        ...
                        <div>
                            <label className="flex items-start gap-2 cursor-pointer group">
                                ...
                                />
                                <div className={`w-3.5 h-3.5 rounded border-2 flex items-center justify-center shrink-0 mt-0.5 transition-all ${agreeTerms ? "bg-blue-600 border-blue-600" : "border-gray-300 bg-white group-hover:border-gray-400"}`}>
                                    {agreeTerms && <CheckCircle2 className="w-2.5 h-2.5 text-white" />}
                                </div>
