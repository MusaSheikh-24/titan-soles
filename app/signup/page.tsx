            ...
            >
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    >
                        ...
                        <p className="mt-3 text-sm text-gray-400 leading-relaxed max-w-md">
                            Join thousands of collectors, traders, and enthusiasts on the AI-powered marketplace that understands your style.
                        </p>
                    </motion.div>
                ...
                >
                    <div className="border-l-2 border-blue-600/50 pl-4">
                        <p className="text-sm text-gray-400 italic">&ldquo;The best marketplace for sneakerheads. The AI matching is uncanny.&rdquo;</p>
                        <p className="text-xs text-gray-500 mt-1.5 font-medium">— Marcus J., Verified Collector</p>
                    </div>
                </motion.div>
            </motion.div>
                ...
                <div className="w-full max-w-md flex flex-col justify-center h-full">
                                    ...
                                    >
                                        ...
                                        <div className="text-left">
                                            ...
                                            <p className="text-[10px] text-gray-500 leading-tight">
                                                {r === "user" ? "Browse & discover" : "List & sell products"}
                                            </p>
                                        </div>
                                    </button>
                                );
                    ...
                    >
                        ...
                        <div>
                            <label className="flex items-start gap-2.5 cursor-pointer group">
                                ...
                                <div
                                    className={`w-4 h-4 rounded-md border-2 flex items-center justify-center shrink-0 mt-0.5 transition-all duration-150 ${agreeTerms ? "bg-blue-600 border-blue-600" : "border-gray-300 bg-white group-hover:border-gray-400"
                                        }`}
                                >
                    ...
                    <div className="relative my-4">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-white px-3 text-[10px] font-semibold uppercase tracking-wider text-gray-400">Or continue with</span>
                        </div>
                    </div>
